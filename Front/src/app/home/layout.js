      ...
      <> 
        <div>
          <header className={styles.header}>
            <div class="logo">
            <a href={"http://localhost:4000/home?idUsuario=" + localStorage.getItem("idUsuario")}>
                <img src='/5411estate.jfif' alt="Logo"></img>
            </a>
            </div>
            <nav>
            <ul>
                <li><a href={"http://localhost:4000/home/equipo?idUsuario=" + localStorage.getItem("idUsuario")}>Equipo</a></li>
                <li><a href={"http://localhost:4000/home/propiedades?idUsuario=" + localStorage.getItem("idUsuario")}>Propiedades</a></li>
                <li><a href={"http://localhost:4000/home/contacto?idUsuario=" + localStorage.getItem("idUsuario")}>Contacto</a></li>
                <li><a href={"http://localhost:4000/home/chat?idUsuario=" + localStorage.getItem("idUsuario")}>Chats</a></li>
            </ul>
            </nav>
          </header> {children}
        </div>
